...
class DoubleClickConfig(
    private val doubleCheckClass: String = "github.leavesczy.asm.double_click.ViewDoubleClickCheck",
    val doubleCheckMethodName: String = "canClick",
    val doubleCheckMethodDescriptor: String = "(Landroid/view/View;)Z",
    private val checkViewOnClickAnnotation: String = "github.leavesczy.asm.double_click.CheckViewOnClick",
    private val uncheckViewOnClickAnnotation: String = "github.leavesczy.asm.double_click.UncheckViewOnClick",
