...
class OptimizedThreadConfig(
    private val optimizedThreadClass: String = "github.leavesczy.asm.optimized_thread.OptimizedThread",
    private val optimizedThreadPoolClass: String = "github.leavesczy.asm.optimized_thread.OptimizedExecutors",
