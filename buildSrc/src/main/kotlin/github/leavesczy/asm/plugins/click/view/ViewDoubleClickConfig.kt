...
data class ViewDoubleClickConfig(
    private val doubleClickCheckClass: String = "github.leavesczy.asm.click.view.ViewDoubleClickCheck",
    val onClickMethodName: String = "onClick",
    private val checkViewOnClickAnnotation: String = "github.leavesczy.asm.click.view.annotation.CheckViewOnClick",
    private val uncheckViewOnClickAnnotation: String = "github.leavesczy.asm.click.view.annotation.UncheckViewOnClick",
